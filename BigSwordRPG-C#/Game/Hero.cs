...
namespace BigSwordRPG.Game
{
    ...
    {
        public Hero(string name, int health, int level, int damage, string type, int speed, List<Abilities> abilities, bool isDead) : base(name, health, level, damage, type, speed, abilities, isDead)
        {
        }
